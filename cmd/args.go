...
type Args struct {
	...
	// Browser Validation Options (MANDATORY - CORE REQUIREMENT)
	...
	Beef                      bool // Enable BeEF integration
	Vpn                       bool // Enable VPN awareness
	PuppeteerHeadless         bool // Enable Puppeteer-based headless verification
}
